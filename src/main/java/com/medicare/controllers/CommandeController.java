...
public class CommandeController {
    ...
    private void loadCommandes() {
        ...
        statusFilter.getItems().addAll("Tous", "en_attente_paiement", "en_attente", "confirmee", "livree", "annulee");
        statusFilter.setValue("Tous");
        statusFilter.setStyle("-fx-background-radius: 8; -fx-font-size: 12px;");
        statusFilter.setOnAction(e -> {
            String value = statusFilter.getValue();
            if ("Tous".equals(value)) addRows(service.getAll());
            else addRows(service.getByStatus(value));
        });
        ...
        btnVerify.setStyle("-fx-background-color: #7c3aed; -fx-text-fill: white; -fx-font-size: 12px; -fx-background-radius: 8; -fx-cursor: hand; -fx-padding: 6 14;");
        ...
        tableHeader.getChildren().addAll(
                ...
                colLabel("Statut", 130), colLabel("Actions", 235)
        );
    ...
    private void addRows(List<Commande> commandes) {
        ...
        for (int i = 0; i < commandes.size(); i++) {
            ...
            Label client = cellLabel(c.getUserFullName() != null && !c.getUserFullName().isBlank() ? c.getUserFullName() : "-", 140, "#555");
            ...
            actions.setPrefWidth(235);
            actions.setMinWidth(235);
            ...
            btnAccept.setOnAction(e -> {
                ...
                showPopup("Commande acceptee", c.getCommandeNumber() != null ? c.getCommandeNumber() : "Commande #" + c.getId(), FontAwesomeSolid.CHECK_CIRCLE, "#16a34a");
            });
            ...
            btnReject.setOnAction(e -> {
                ...
                showPopup("Commande rejetee", c.getCommandeNumber() != null ? c.getCommandeNumber() : "Commande #" + c.getId(), FontAwesomeSolid.BAN, "#dc2626");
            });
            ...
            btnDeliver.setOnAction(e -> {
                ...
                showPopup("Commande livree", c.getCommandeNumber() != null ? c.getCommandeNumber() : "Commande #" + c.getId(), FontAwesomeSolid.TRUCK, "#1a73e8");
            });
    ...
    private void filterCommandes(String search) {
        if (search == null || search.trim().isEmpty()) addRows(service.getAll());
        else addRows(service.search(search));
    }
    ...
    private void showDetails(Commande c) {
        ...
        closeBtn.setStyle("-fx-background-color: #7c3aed; -fx-text-fill: white; -fx-font-size: 13px; -fx-background-radius: 8; -fx-cursor: hand; -fx-padding: 6 30;");
    ...
    private void downloadPdf(Commande c) {
        ...
        try {
            ...
            ex.printStackTrace();
            showPopup("Echec generation", ex.getMessage(), FontAwesomeSolid.EXCLAMATION_TRIANGLE, "#dc2626");
        }
    }
    ...
    private void openVerifyWindow() {
        try {
            ...
            ex.printStackTrace();
            showPopup("Erreur", "Impossible d'ouvrir la fenetre de verification.", FontAwesomeSolid.EXCLAMATION_TRIANGLE, "#dc2626");
        }
    }
}
