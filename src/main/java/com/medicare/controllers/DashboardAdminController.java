...
public class DashboardAdminController {
    ...
    private Button[] allButtons() {
        return new Button[]{btnAccueil, btnUtilisateurs, btnRendezVous,
                            btnDonation, btnProduit, btnCommande, btnCollaboration, btnForum};
    }
    ...
    private void initialize() {
        ...
        btnProduit.setGraphic(icon(FontAwesomeSolid.BOX));
        btnCommande.setGraphic(icon(FontAwesomeSolid.SHOPPING_CART));
