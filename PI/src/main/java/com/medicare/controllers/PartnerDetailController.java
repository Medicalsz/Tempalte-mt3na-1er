        ...
        ratingsListView.setCellFactory(lv -> new ListCell<PartnerRating>() {
            ...
            protected void updateItem(PartnerRating item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    ratingLabel.getStyleClass().add("comment-rating-label");
                    ratingLabel.setTextFill(item.getRating() >= 3 ? Color.GREEN : Color.ORANGERED);

                    Label userNameLabel = new Label(item.getUserName());
                    userNameLabel.getStyleClass().add("comment-user-name");
                    ...
                    dateLabel.getStyleClass().add("comment-date-label");
                    ...
                    header.getChildren().addAll(ratingLabel, userNameLabel, sentimentIcon, dateLabel);

                    // Only show the comment text if it exists
